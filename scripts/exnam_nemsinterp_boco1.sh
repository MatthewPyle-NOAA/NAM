...
#                      .                                             .
# Script name:         exnam_nemsinterp_boco1.sh.ecf
...
cat $PARMnam/nam_namelist.nps_bocos | sed s:YSTART:$ystart: | sed s:MSTART:$mstart: \
 ...
 | sed s:MEND:$mmint1: | sed s:DEND:$ddint1: | sed s:HEND:$hhint1:g > namelist.nps
...
cp boco.0003 $COMOUT/nam.t${cyc}z.boco.01.003.${tmmark}
cp boco.0006 $COMOUT/nam.t${cyc}z.boco.01.006.${tmmark}
cp boco.0009 $COMOUT/nam.t${cyc}z.boco.01.009.${tmmark}
