...
#                      .                                             .
# Script name:         exnam_nemsinterp_boco3.sh.ecf
...
cat $PARMnam/nam_namelist.nps_bocos | sed s:YSTART:$yyint2: | sed s:MSTART:$mmint2: \
 ...
 | sed s:MEND:$mmint3:     | sed s:DEND:$ddint3: | sed s:HEND:$hhint3:g > namelist.nps
...
cp boco.0000 $COMOUT/nam.t${cyc}z.boco.01.024.${tmmark}
cp boco.0003 $COMOUT/nam.t${cyc}z.boco.01.027.${tmmark}
cp boco.0006 $COMOUT/nam.t${cyc}z.boco.01.030.${tmmark}
cp boco.0009 $COMOUT/nam.t${cyc}z.boco.01.033.${tmmark}
