...
#                      .                                             .
# Script name:         exnam_sfcupdate_nest_tm00.sh.ecf
# Script description:  Update sst/snow/sea ice for NAM run
#
# Author:        Eric Rogers       Org: NP22         Date: 1999-06-23
#
# Abstract: Update NAM nest restart/input files with best
...
# 2015-??-??  Rogers/Carley - Mods for NAMv4
...
cpreq $GESDIR/nam.t${cyc}z.input_nemsio_guess_${domain}nest_tm00_presfcupdate input_nemsio_${DOMAIN}
...
# When coldstarting NAM off GDAS update every cycle
...
mv input_nemsio_${DOMAIN} $GESDIR/nam.t${cyc}z.input_domain_${domain}nest_nemsio.tm00
export err=$?;err_chk
