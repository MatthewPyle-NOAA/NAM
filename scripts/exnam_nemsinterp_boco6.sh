...
#                      .                                             .
# Script name:         exnam_nemsinterp_boco6.sh.ecf
...
cat $PARMnam/nam_namelist.nps_bocos | sed s:YSTART:$yyint5: | sed s:MSTART:$mmint5: \
 ...
 | sed s:MEND:$mmint6:   | sed s:DEND:$ddint6: | sed s:HEND:$hhint6:g > namelist.nps
...
cp boco.0000 $COMOUT/nam.t${cyc}z.boco.01.060.${tmmark}
cp boco.0003 $COMOUT/nam.t${cyc}z.boco.01.063.${tmmark}
cp boco.0006 $COMOUT/nam.t${cyc}z.boco.01.066.${tmmark}
cp boco.0009 $COMOUT/nam.t${cyc}z.boco.01.069.${tmmark}
