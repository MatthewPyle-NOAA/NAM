...
#                      .                                             .
# Script name:         exnam_nemsinterp_boco4.sh.ecf
...
cat $PARMnam/nam_namelist.nps_bocos | sed s:YSTART:$yyint3: | sed s:MSTART:$mmint3: \
 ...
 | sed s:MEND:$mmint4:     | sed s:DEND:$ddint4: | sed s:HEND:$hhint4:g > namelist.nps
...
cp boco.0000 $COMOUT/nam.t${cyc}z.boco.01.036.${tmmark}
cp boco.0003 $COMOUT/nam.t${cyc}z.boco.01.039.${tmmark}
cp boco.0006 $COMOUT/nam.t${cyc}z.boco.01.042.${tmmark}
cp boco.0009 $COMOUT/nam.t${cyc}z.boco.01.045.${tmmark}
