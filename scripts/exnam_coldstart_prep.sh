...
# Can use GFS "bocos" Vtable for GRIB2 input
...
mv input_domain_01_nemsio $GESDIR/nam.t${cyc}z.input_domain_01_nemsio.tm06_precoldstart
rm input_domain_01
cp $GESDIR/nam.t${cyc}z.input_domain_01_nemsio.tm06_precoldstart  $GESDIR/nam.t${cyc}z.input_domain_01_nemsio.tm06
export err=$?;err_chk
