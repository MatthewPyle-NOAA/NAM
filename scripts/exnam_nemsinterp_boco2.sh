...
#                      .                                             .
# Script name:         exnam_nemsinterp_boco2.sh.ecf
...
cat $PARMnam/nam_namelist.nps_bocos | sed s:YSTART:$yyint1: | sed s:MSTART:$mmint1: \
 ...
 | sed s:MEND:$mmint2:     | sed s:DEND:$ddint2: | sed s:HEND:$hhint2:g > namelist.nps
...
cp boco.0000 $COMOUT/nam.t${cyc}z.boco.01.012.${tmmark}
cp boco.0003 $COMOUT/nam.t${cyc}z.boco.01.015.${tmmark}
cp boco.0006 $COMOUT/nam.t${cyc}z.boco.01.018.${tmmark}
cp boco.0009 $COMOUT/nam.t${cyc}z.boco.01.021.${tmmark}
