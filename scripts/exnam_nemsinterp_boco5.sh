...
#                      .                                             .
# Script name:         exnam_nemsinterp_boco5.sh.ecf
...
cat $PARMnam/nam_namelist.nps_bocos | sed s:YSTART:$yyint4: | sed s:MSTART:$mmint4: \
 ...
 | sed s:MEND:$mmint5:   | sed s:DEND:$ddint5: | sed s:HEND:$hhint5:g > namelist.nps

yy1=`echo $int4 | cut -c1-4`
mm1=`echo $int4 | cut -c5-6`
dd1=`echo $int4 | cut -c7-8`
hh1=`echo $int4 | cut -c9-10`
...
cp boco.0000 $COMOUT/nam.t${cyc}z.boco.01.048.${tmmark}
cp boco.0003 $COMOUT/nam.t${cyc}z.boco.01.051.${tmmark}
cp boco.0006 $COMOUT/nam.t${cyc}z.boco.01.054.${tmmark}
cp boco.0009 $COMOUT/nam.t${cyc}z.boco.01.057.${tmmark}
