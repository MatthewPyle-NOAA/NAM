#! /bin/sh
#
# Metafile Script : nam32_meta_qpf.sh
#
# Log :
# J. Carr/HPC    02/28/2001    New script for the 32 km NAM.
# J. Carr/HPC        5/2001    Added a mn variable for a/b side dbnet root variable.
# J. Carr/HPC        6/2001    Edited to expand out to f84
# J. Carr/HPC        6/2001    Converted to a korn shell prior to delivering script to Production.
# J. Carr/HPC        7/2001    Submitted.
# J. Carr/PMB       11/2004    Added a ? to all title/TITLE lines. Changed contur variable to a 2
#                              instead of 1.
# E.Rogers/EMC      10/2016    Used nam44 script as template for nam32 version
#
# Set up Local Variables
#
set -x
#
export PS4='nam32:$SECONDS + '
mkdir $DATA/nam32
cd $DATA/nam32
...
hilo     = 31;0/x#2/.15-20/100;100/6!17/H#;L#/1020-1070;900-1012/6
