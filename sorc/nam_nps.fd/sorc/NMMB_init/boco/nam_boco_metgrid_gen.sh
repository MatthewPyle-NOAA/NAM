...
ls -l $FIXnam/nam_geo_nmb.d01.dio
...
cp $DATAROOT/run_ungrib/FILE:${yy}-${mm}-${dd}_${hh} .
...
for fl in $files
do
mv ${fl} $DATAROOT/run_metgrid/nam.t${CYC}z.${fl}
done
fi
...
echo nonzero err $err so skipped
