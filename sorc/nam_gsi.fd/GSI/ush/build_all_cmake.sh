...
##cmake -DBUILD_GSDCLOUD_NMMB=ON -DBUILD_UTIL=OFF -DMPI3FLAG=-DMPI3 -DMPI3=ON -DBUILD_ENKF=OFF -DBUILD_NCIO_UTIL=OFF -DBUILD_NCDIAG_SERIAL=OFF -DCMAKE_BUILD_TYPE=$build_type -DBUILD_CORELIBS=OFF ..
  cmake -DBUILD_GSDCLOUD_NMMB=ON -DBUILD_UTIL=OFF -DBUILD_ENKF=OFF -DBUILD_NCIO_UTIL=OFF -DBUILD_NCDIAG_SERIAL=OFF -DCMAKE_BUILD_TYPE=$build_type -DBUILD_CORELIBS=OFF ..
else 
  cmake ..
fi
