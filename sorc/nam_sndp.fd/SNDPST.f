...
C----------------------------------------------------------------------
      LUNIT=66
      LRECPR=4*(8+9+LCL1ML*LM1+LCL1SL)
      OPEN(UNIT=LUNIT,ACCESS='DIRECT',RECL=LRECPR,IOSTAT=IER)
      NREC=0
 33   CONTINUE
      NREC=NREC+1
!rv   READ(LUNIT,REC=NREC,END=999) IHRST,IDATE,IFCST,ISTAT,CISTAT,  
      READ(LUNIT,REC=NREC,IOSTAT=IERR) IHRST,IDATE,IFCST,ISTAT,CISTAT,
