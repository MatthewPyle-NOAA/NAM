...
!   instantaneous -10 C reflectivity
...
!           REFD at -10 C level
                 DO J=JSTA,JEND
                 DO I=1,IM
                   GRID1(I,J)=DBZ(I,J,Zm10c(I,J)) ! DBZ seems correct.  DBZ1 interpolated from DBZ
                                                  ! used for 1000 m AGL type fields
                 ENDDO
                 ENDDO
