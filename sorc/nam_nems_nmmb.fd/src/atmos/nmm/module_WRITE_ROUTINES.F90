...
!
        CALL MPI_ISEND(ALL_DATA_INT_ATT                                &  !<-- String of integer Attribute output data
...
!
        CALL MPI_ISEND(ALL_DATA_REAL_ATT                               &  !<-- String of real Attribute output data
...
!
        CALL MPI_ISEND(ALL_DATA_LOG_ATT                                &  !<-- String of logical Attribute output data
