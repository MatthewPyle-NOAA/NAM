...
!-----------------------------------------------------------------------
!
      INTEGER, PARAMETER :: MAX_VARS = 350
...
!
        ...
        REAL(kind=KFPT),DIMENSION(:,:),POINTER :: REFDMAX263K      => NULL()
...
!.. new memory but rather pointers into TRACERS array.
      ...
      CALL SET_VAR_PTR(int_state%VARS,NV,'REFDMAX263K',int_state%REFDMAX263K,(/ IMS,JMS /),(/ IME,JME /) )
