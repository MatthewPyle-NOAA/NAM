...
then
   ...
   export COMIN=${COMIN:-${COMROOTp3}/$NET/$envir/$NET.$PDY/${cyc}}
   export COMOUTwmo=${COMOUTwmo:-${COMROOTp3}/${NET}/${envir}/${RUN}.${PDY}/${cyc}/wmo}
...
#         DBNALERT_TYPE=NTC_LOW
   ...
   $executable < $PARMutil/$parmcard $parm >> $pgmout 2>errfile
#    export err=$?;err_chk
