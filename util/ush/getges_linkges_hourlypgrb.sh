...
# Any resolution production
 ...
 case $typef in
  ...
  pgbcur) geslist='
   ...
   ;;
  pg2cur) geslist='
   $COMINgdas/gdas.${day}/${cyc}/atmos/gdas.t${cyc}z.pgrb2.0p25.f$gh
   $COMINgfs/gfs.${day}/${cyc}/atmos/gfs.t${cyc}z.pgrb2.0p25.f$gh'
   fhbeg=00
   ;;
  p05cur) geslist='
   $COMINgdas/gdas.${day}/${cyc}/atmos/gdas.t${cyc}z.pgrb2.0p50.f$gh
   $COMINgfs/gfs.${day}/${cyc}/atmos/gfs.t${cyc}z.pgrb2.0p50.f$gh'
   fhbeg=00
   ;;
  prepqc) geslist='
