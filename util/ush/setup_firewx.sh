...
. ${HOMEnam}/versions/run.ver
EXECfirewx=${HOMEnam}/util/exec
COMOUT=/lfs/h1/ops/${envir}/com/nam/${nam_ver}/input
...
do
 ...
 if [ "$enter_dat" = "yes" ]
  ...
  cp -p $COMOUT/nam_firewx_loc $COMOUT/nam_firewx_loc_prev
