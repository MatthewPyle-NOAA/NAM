       SUBROUTINE  FOUS40( IREC )
C$$$  SUBPROGRAM DOCUMENTATION BLOCK                       
C                                                          
C SUBPROGRAM: FOUS40         GENERATES THE FOUS40-43 BULLETINS 
C   PRGMMR: BOB HOLLERN      ORG: W/NMC41    DATE: 93-06-01
C                                                          
C ABSTRACT: FORMATS THE FOUS40-43 BULLETINS, WHICH CONTAIN STATION   
C   FORECASTS FOR THE HOURS 12, 18, 24, ..., 60 OF THE FREEZING LEVEL
...
C   01-04-24  BOI VUONG, MODIFIED TO EXTEND NAM FOUS PRODUCT GENERATION
C             TO 60 HOURS AT 00Z AND 12Z
C                                                          
C USAGE:  CALL FOUS40                                      
C                                                          
...
C                                                          
       REAL      SI(224),   SJ(224)
C                                                          
       INTEGER   IDAYFL(3),   IND1(4),   IND2(4),   LFRZRH(224,11,13)
...
C                                                          
       CHARACTER*1  ENDB,   LF
C                                                          
       CHARACTER*4   FOUSNO(4),   IENDL,   JDAYFL(3),   NFDT(9)
C                                                          
...
C                                                          
          ...
          END DO
C
C         SET NFDT TO THE DATES FOR THE NINE FORCAST PERIODS 
C                                                          
          NFDT(1) = JDAYFL(1)
          NFDT(2) = JDAYFL(1)
          NFDT(7) = JDAYFL(3)
