       SUBROUTINE  FRZLVL( IUNITS, JCYCLE, MERR )
C$$$  SUBPROGRAM DOCUMENTATION BLOCK                                  
C                                                                     
C SUBPROGRAM:  FRZLVL          GETS STN FREEZING LVL HGT AND RH AT HGT
...
C   24, ..., 60 HOUR FORECAST FIELDS.  THE FREEEZING LEVEL VALUES ARE 
...
C   01-04-24  BOI VUONG, MODIFIED TO EXTEND NAM FOUS PRODUCT
C             GENERATION TO 60 HOURS AT 00Z AND 12Z.
C                                                                     
C USAGE:    CALL FRZLVL( IUNITS, JCYCLE, MERR )
C                                                                     
...
C                                                                     
       ...
       INTEGER   IDFRRH(6),   IDFRZL(6),     LFRZRH(224,11,13)
       INTEGER   IUNITS(42)
...
C                                                                     
C                                                            
C  LOOP FOR THE NAM FILES:  00 HR - 60 HR                     
C                                                            
       NFL = 21
       IU = 8
C
